...
Sitio React + Vite con galerías inmersivas y un panel privado de contenido. Desde `/admin` se pueden editar la navegación bilingüe y los contenidos habilitados de Home, Work, Exhibitions, Statement, CV, Workshops y Contact, sin modificar el diseño. Express sirve la API y el frontend desde un único proceso; PostgreSQL se gestiona con Prisma.
