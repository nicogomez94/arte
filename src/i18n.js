...
const messages = {
  ...
  es: {
    ...
    toggleExhibitions: 'Mostrar u ocultar las exhibiciones',
    soloShow: 'Exhibición individual',
    groupShow: 'Exhibición colectiva',
